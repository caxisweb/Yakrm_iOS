...
class Config: NSObject {
    ...
    static let schemeURL = "com.inforaam.Yakrm"//"msdk.demo.async"
    static let mainColor: UIColor = UIColor.init(rgb: 0xEE4158)//init(red: 10.0/255.0, green: 134.0/255.0, blue: 201.0/255.0, alpha: 1.0)
}
