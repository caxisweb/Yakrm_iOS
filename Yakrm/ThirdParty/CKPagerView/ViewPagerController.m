...
static const CGFloat kContentHeight = 209.0f;
...
//    }
    ...
    frame.origin.x = 0.0;
    frame.origin.y = topLayoutGuide;//self.tabLocation == ViewPagerTabLocationTop ? topLayoutGuide : CGRectGetHeight(self.view.frame) - self.tabHeight;//[self.tabLocation boolValue] ? topLayoutGuide : CGRectGetHeight(self.view.frame) - [self.tabHeight floatValue];
    frame.size.width = CGRectGetWidth(self.view.frame);
    frame.size.height = self.tabHeight;//[self.tabHeight floatValue];
    self.tabsView.frame = frame;
        
    frame = self.contentView.frame;
    frame.origin.x = 0.0;
    frame.origin.y = self.tabsView.frame.origin.y + self.tabsView.frame.size.height;
    
    frame.size.width = CGRectGetWidth(self.view.frame);
    frame.size.height = self.view.frame.size.height - self.tabsView.frame.origin.y - self.tabsView.frame.size.height;
    self.contentView.frame = frame;
//    CGFloat topLayoutGuide = self.topLayoutGuide.length;
//
//    CGRect frame = self.tabsView.frame;
//    frame.origin.x = 0.0;
//    frame.origin.y = 64.0;//self.tabLocation == ViewPagerTabLocationTop ? topLayoutGuide : CGRectGetHeight(self.view.frame) - self.tabHeight;
//    frame.size.width = CGRectGetWidth(self.view.frame);
...
//    frame = self.contentView.frame;
//    frame.origin.x = 0.0;
//    frame.origin.y = self.tabsView.frame.size.height + 64;//self.tabLocation == ViewPagerTabLocationTop ? topLayoutGuide + CGRectGetHeight(self.tabsView.frame) : topLayoutGuide;
//    frame.size.width = CGRectGetWidth(self.view.frame);
//    frame.size.height = self.view.frame.size.height - self.tabsView.frame.size.height - 64;//frame.origin.y - 70;CGRectGetHeight(self.view.frame) - (topLayoutGuide + CGRectGetHeight(self.tabsView.frame)) - (self.tabBarController.tabBar.hidden ? 0 : CGRectGetHeight(self.tabBarController.tabBar.frame));
//    self.contentView.frame = frame;
}
