...
//            self.btnVarify.setTitle("تحقق", for: .normal)
    ...
    func ResendOTPAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)checked_mobile_for_forgetpassword", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
