...
//            self.btnChange.setTitle("تغير كلمة المرور", for: .normal)
    ...
    func ChangePasswordAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)forgot_and_change_new_password", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
