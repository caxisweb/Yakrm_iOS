...
//
    ...
    func getFilterVoucherAPI() {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)filter_voucher", method: .post, parameters: parameters, headers: headers, loader: true) { (statusCode, response, error) in
    ...
    func SearchBrandAPI() {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)search_brand", method: .post, parameters: parameters, headers: headers, loader: true) { (statusCode, response, error) in
