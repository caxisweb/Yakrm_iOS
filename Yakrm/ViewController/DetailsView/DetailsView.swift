...
//        loadingNotification.dimBackground = true
        ...
        AF.request("\(self.app.BaseURL)getAllVoucherByBrandId", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
...
//        loadingNotification.dimBackground = true
        ...
        AF.request("\(self.app.BaseURL)add_to_cart", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
