...
class CouponNearEndView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func GetEndedVouchersOfUserAPI() {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)get_ended_vouchers_of_user_very_soon", method: .get, parameters: nil, headers: headers, loader: true) { (statusCode, response, error) in
