...
class FavoritesView: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    func getFavouriteAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)getAllFavouritesList", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
