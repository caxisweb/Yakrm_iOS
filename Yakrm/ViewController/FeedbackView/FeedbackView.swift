...
//        txt.placeHolderColor = UIColor.black
    ...
    func AddFeedbackAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)add_feedback", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
