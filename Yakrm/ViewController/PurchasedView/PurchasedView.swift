...
//        self.lblBalancePrice.text = self.strTotal
    ...
    func VoucherPurchaseAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)voucher_purchase", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let cancelAction = UIAlertAction(title: "NO".localized, style: .default) { (action:UIAlertAction!) in
...
//            }
    ...
    func CreatePayPageAPI()
    {
        ...
        Alamofire.request("https://www.paytabs.com/apiv2/create_pay_page", method: .post, parameters: parameters, encoding: URLEncoding.default).responseJSON { response in
            debugPrint(response)
    ...
    func GetAllCardsOfUsersAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)get_all_cards_ofusers", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
...
//        print(y)
        ...
        Alamofire.request("\(self.app.BaseURL)checkout", method: .post, parameters: parameters, encoding: JSONEncoding.default).responseJSON { response in
            debugPrint(response)
            print(response)
...
//        }
    ...
    func PaymentStatusAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)paymentstatus", method: .post, parameters: parameters, encoding: JSONEncoding.default).responseJSON { response in
            debugPrint(response)
