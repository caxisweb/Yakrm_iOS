...
class CartView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func DeleteCartAPI(isCheck: Bool) {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)remove_voucher_from_cart", method: .post, parameters: parameters, headers: headers, loader: true) { (statusCode, response, error) in
