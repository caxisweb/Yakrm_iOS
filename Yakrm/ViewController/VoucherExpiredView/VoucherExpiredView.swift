...
class VoucherExpiredView: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        cell.lblDiscount.text = "\(indexPath.section) " + "Discounts Of Voucher".localized
        
        let strAvailable = "Ended By".localized + "13/13/2018"
        ...
        cell.lblPrice.text = "\(indexPath.section)0" + "SR".localized
