...
class VoucherExpiredView: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    func GetEndedVouchersOfUserAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)get_ended_vouchers_of_user", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
