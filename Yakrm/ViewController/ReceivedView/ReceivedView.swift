...
//    }
    ...
    func getAllGiftReceivedAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)get_all_gift_received", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
