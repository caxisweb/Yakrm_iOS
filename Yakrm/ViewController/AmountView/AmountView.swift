...
//        self.txtPrice.placeHolderColor = UIColor.darkGray.withAlphaComponent(0.5)
    ...
    func ReplaceVoucherAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)replace_voucher", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
