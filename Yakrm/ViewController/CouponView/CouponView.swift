...
//        }
    ...
    @IBAction func btnSignOut(_ sender: UIButton)
    {
        ...
        let OKAction = UIAlertAction(title: "Logout".localized, style: .destructive) { (action:UIAlertAction!) in
    ...
    func getActiveVoucherAPI(isLoading : Bool)
    {
        ...
        Alamofire.request("\(self.app.SalesURL)get_all_brands_of_vendors", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
