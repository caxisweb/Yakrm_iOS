...
class RegisterView: UIViewController, UITextFieldDelegate {
    ...
    func getSignUpAPI() {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)registration_step_2", method: .post, parameters: parameters, headers: headers, loader: true) { (statusCode, response, _) in
