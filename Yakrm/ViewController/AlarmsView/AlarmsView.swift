...
//        lbl.font = UIFont (name: "GE SS Two Medium", size: lblFontSize)
    ...
    func GetNotificationAPI() {
        ...
        AppWebservice.shared.request("\(self.app.BaseURL)get_users_notifications_history", method: .get, parameters: nil, headers: headers, loader: true) { (statusCode, response, _) in
