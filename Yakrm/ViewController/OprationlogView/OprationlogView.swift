...
//        var strType : String = arrValue[indexPath.section]["voucher_price"].stringValue
    ...
    func getAllUserTransactionAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)get_all_usertransaction", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
