...
//                            self.webView.isHidden = false
    ...
    func AddPaymentCardsAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)add_payment_cards", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
    ...
    func UpdatePaymentCardsAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)edit_card_of_users", method: .post, parameters: parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
