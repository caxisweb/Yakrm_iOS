...
//            self.lblTITLE.text = "التعليمات والشروط"
    ...
    func GetAboutApplicationAPI()
    {
        ...
        Alamofire.request("\(self.app.BaseURL)get_about_application", method: .get, parameters: nil, encoding: JSONEncoding.default, headers: headers).responseJSON { response in
            debugPrint(response)
